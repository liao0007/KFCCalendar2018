...
public class SingleTouchView extends View {
    ...
    public static final int DEFAULT_CONTROL_DEL_LOCATION = LEFT_TOP;
     ...
     * 用于缩放，旋转的控制点的坐标
     */
    private Point mControlDelPoint = new Point();
    ...
    private int mDrawableDelWidth, mDrawableDelHeight;
     ...
     */
    private int controlDelLocation = DEFAULT_CONTROL_DEL_LOCATION;
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        controlDelete = mTypedArray.getDrawable(R.styleable.SingleTouchView_controlDelete);
        controlLocation = mTypedArray.getInt(R.styleable.SingleTouchView_controlLocation, DEFAULT_CONTROL_LOCATION);
        controlDelLocation = mTypedArray.getInt(R.styleable.SingleTouchView_controlDelLocation, DEFAULT_CONTROL_DEL_LOCATION);
...
//            canvas.drawRect(mLTPoint.x,mLTPoint.y,mRTPoint.x,mRBPoint.y,paint);


            //画删除图标
            controlDelete.setBounds(mLTPoint.x - mDrawableDelWidth / 2, mLTPoint.y - mDrawableDelHeight / 2,
                    mLTPoint.x + mDrawableDelWidth / 2, mLTPoint.y + mDrawableDelHeight / 2);
...
//            canvas.drawRect(mLTPoint.x,mLTPoint.y,mControlPoint.x,mControlPoint.y,paint);
        }
...
//        }
     ...
     * 设置控制图标
     */
    public void setControlDelete(Drawable controlDelete) {
    ...
    public int getControlDelLocation() {
        return controlDelLocation;
    }
